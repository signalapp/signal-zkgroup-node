...
class ProfileKeyCommitment extends ByteArray_1.default {
    ...
    getProfileKeyVersion() {
        ...
        const ffi_return = Native_1.default.FFI_ProfileKeyCommitment_getProfileKeyVersion(this.contents, this.contents.length, newContents, newContents.length);
        if (ffi_return != Native_1.FFI_RETURN_OK) {
            throw new ZkGroupError_1.default("FFI_RETURN!=OK");
        }
